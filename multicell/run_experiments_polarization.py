...
with open("c01_polarization_no_migration.pyb","wb") as fh:
...
with open("c05_polarization_no_migration.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c09_polarization_no_migration.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c01_polarization_migration3.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c05_polarization_migration3.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c09_polarization_migration3.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c01_polarization_migration6.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c05_polarization_migration6.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c09_polarization_migration6.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
