...
with open("initial_condition_polarization.pyb","wb") as fh:
...
with open("c01_polarization_no_migration_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c05_polarization_no_migration_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c09_polarization_no_migration_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c01_polarization_migration3_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c05_polarization_migration3_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c09_polarization_migration3_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c01_polarization_migration6_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c05_polarization_migration6_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
...
with open("c09_polarization_migration6_Tf4.pyb","wb") as fh:
    fh.write(pickle.dumps(results))
